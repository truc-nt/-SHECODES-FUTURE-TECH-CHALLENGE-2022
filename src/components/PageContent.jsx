const PageContent = [
    ...
    },
    {
        ...
        'back_content': `
            <div className = 'row'>
                ...
                <p>
                Khi tìm hiểu về Đà Lạt thì tớ mới thấy rằng Đà Lạt có quá nhiều chỗ để cho ra những tấm hình độc đáo. Điển hình là tớ thấy những góc chụp siêu lạ tại đường hầm điêu khắc Đà Lạt.
                Nghe nói là đường hầm này tái hiện lịch sử hình thành Đà Lạt. 
                </p>
                <p>Ngoài ra, còn có Lumiere Đà Lạt. Nơi có tên gọi khác là Vườn ánh sáng Đà Lạt. Chỉ mới nhìn vài hình ảnh chụp nơi này mà tớ đã thấy được sự lung linh, huyền ảo của nó. 
                Có những bức ảnh gia đình đầy ánh sáng, sắc màu tại nơi đây sẽ làm cho album thêm phần độc lạ.
            </div>
        `
    },
    {
    ...
    },
    {
        ...
        <div className = 'row'>
            <p>Đi du lịch thì đương nhiên phải khám phá các món ăn đặc sản ở đây rồi. Tớ sẽ cùng với gia đình đi ăn sập Hà Nội mới được.</p>
        </div>
        <div className = 'row'>
    ...
    },
    {
        ...
        'front_content': `
            <div></div>
            <p>Ăn xong thì cả gia đình sẽ cùng nhau dạo quanh khu phố cổ Hà Nội, cùng nhau ngắm nhìn những ngôi nhà cổ kính, những con đường mang ký ức lịch sử, nét văn hóa Hà thành ở nơi đây.</p>
        `,
        'back_content': `
            <div className = 'row'>
                <div className = 'col-6'></div>
                <div className = 'col-6'>
                    <p>Tớ cũng muốn cùng cả nhà đi đến Hạ Long - nơi có di sản được UNESCO công nhận là Di sản thiên nhiên thế giới. Cùng nhau ngắm nhìn thiên nhiên hùng vĩ, khám phá hang động, ...</p>
                </div>
                <h1>Ha</h1>
                <h1>Long</h1>
            </div>
    ...
    },
    {
        ...
        'front_content': `
            <div className = 'row'>
                <div className = 'col-6'>
                    <div></div>
                    <p>Nếu được đến đây, nhất định cả gia đình phải có một tấm ảnh chụp trong bộ đồ truyền thống của Nhật Bản dưới gốc cây anh đào.</p>
                </div>
                <div className = 'col-6'>
