const PageContent = [
    ...
    },
    {
        ...
        'back_content': `
            ...
            <p>It has survived not only five centuries, but also the leap , and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
        `,
    },
    {
        'id': 'p14',
    ...
    },
    {
        ...
        'front_content': `
          ...
          <h1>Taste</h1>
          <h1>the food</h1>
          <div className = 'row'><p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p></div>
        `,
        'back_content': `
            <div></div>
            <div></div>
